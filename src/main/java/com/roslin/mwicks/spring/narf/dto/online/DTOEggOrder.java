...
public class DTOEggOrder {
    ...
    private EggOrderLineFertilised orderLineFertilised;
    private Line line;
    ...
    public EggOrderLineFertilised getOrderLineFertilised() {
    	return this.orderLineFertilised;
    }
    public Line getLine() {
    	return this.line;
    }
    ...
    public void setOrderLineFertilised(EggOrderLineFertilised orderLineFertilised) {
    	this.orderLineFertilised = orderLineFertilised;
    }
     ...
     */
    public boolean isSameAs(DTOEggOrder dtoorder){
        ...
        if (
        		...
        		this.getOrderLineFertilised().equals(dtoorder.getOrderLineFertilised()) &&
    ...
    public void update(
    		...
    		int supplied,
    		Date suppliedDate,
    		EggOrderLineFertilised orderLineFertilised,
    		Line line,
    ...
    public static class Builder {
        ...
        Builder(
        	...
        	built.orderLineFertilised = orderLineFertilised;
        	built.line = line;
